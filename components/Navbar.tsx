          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <Link className="text-sm font-medium hover:underline" to={"/about" as any}>About</Link>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to={"/about" as any} className="px-3 py-2 rounded-lg text-sm font-medium block hover:underline">About</Link>
