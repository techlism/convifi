...
import { Shield, Lock, MegaphoneSimple, CheckSquare } from "@phosphor-icons/react"
...
export function FeatureSection() {
  const features = [
    ...
    {
      icon: <MegaphoneSimple size={40} className="text-primary" />,
    ...
    <section id="features" className="py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          >
            Everything runs locally in your browser using WebAssembly. Your files never leave your device.
          </motion.p>
        </div>
